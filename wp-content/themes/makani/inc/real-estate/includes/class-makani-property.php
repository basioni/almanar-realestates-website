<?php
class makani_Property {
    private $property_id;
    /*
     * array property meta keys
     */
    private $meta_keys = array(
        'price'                 => 'makani_property_price',
        'price_postfix'         => 'makani_property_price_postfix',
        'custom_id'             => 'makani_property_id',
        'area'                  => 'makani_property_size',
        'area_postfix'          => 'makani_property_size_postfix',
        'beds'                  => 'makani_property_bedrooms',
        'baths'                 => 'makani_property_bathrooms',
        'garages'               => 'makani_property_garage',
        'additional_details'    => 'makani_additional_details',
        'address'               => 'makani_property_address',
        'map_location'          => 'makani_property_location',
        'attachments'           => 'makani_attachments',
        'agent_display_option'  => 'makani_agent_display_option',
        'agent_id'              => 'makani_agents',
        'slider_image'          => 'makani_slider_image',
		'property_images'       => 'makani_property_images',
        'payment_status'        => 'payment_status',
        'video_url'             => 'makani_tour_video_url',
        'video_image'           => 'makani_tour_video_image',
    );
    /**
     * array   $meta_data  contains custom fields data related to a property
     */
    private $meta_data;
    /**
     * int $property_id
    ...
    public function get_property_images() {
        ...
        $property_images_id = $this->get_property_meta( $this->meta_keys['property_images'] );
        if ( $property_images_id ) {
            return wp_get_attachment_url( $property_images_id );
        }
    ...
    public static function format_price ( $price_amount, $price_postfix = '' ) {
        ...
        if( $price_amount ) {
            ...
            $currency_sign      = $makani_real_estate->get_currency_sign();
            $number_of_decimals = $makani_real_estate->get_number_of_decimals();
            $decimal_separator  = $makani_real_estate->get_decimal_separator();
            $thousand_separator = $makani_real_estate->get_thousand_separator();
            $currency_position  = $makani_real_estate->get_currency_position();
            ...
            return $makani_real_estate->get_empty_price_text();

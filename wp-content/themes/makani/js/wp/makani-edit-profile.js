jQuery(document).ready(function($) {
    ...
    if ( typeof editProfile !== "undefined" ) {
        ...
        var uploader = new plupload.Uploader({
            ...
            file_data_name: 'makani_upload_file',
        ...
        if ( ie <= 9 ) {
            $('#makani-edit-user').before( '<div class="ie9-message"><i class="fa fa-info-circle"></i>&nbsp; <strong>Current browser is not fully supported:</strong> Please update your browser or use a different one to enjoy all features on this page. </div>' );
        }

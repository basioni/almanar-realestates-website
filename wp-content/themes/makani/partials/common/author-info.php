...
<div class="inner-wrapper clearfix">
    ...
    if ( isset( $current_author_meta['profile_image_id'] ) ) {
        ...
        <figure class="agent-image">
            <?php echo wp_get_attachment_image( $current_author_meta['profile_image_id'][0], 'makani-agent-thumbnail', false, array( 'class' => 'img-circle' ) ); ?>
        </figure>
        <?php
...
<ul class="agent-contacts-list">
    ...
    if ( isset( $current_author_meta[ 'mobile_number' ] ) && !empty( $current_author_meta[ 'mobile_number' ][0] ) ) {
        ?><li class="mobile"><span><?php _e( 'Mobile:', 'makani' ); ?></span><?php echo esc_html( $current_author_meta[ 'mobile_number' ][0] ); ?></li><?php
    }
    ...
    if ( isset( $current_author_meta[ 'office_number' ] ) && !empty( $current_author_meta[ 'office_number' ][0] ) ) {
        ?><li class="office"><span><?php _e( 'Office:', 'makani' ); ?></span><?php echo esc_html( $current_author_meta[ 'office_number' ][0] ); ?></li><?php
    }
    ...
    if ( isset( $current_author_meta[ 'fax_number' ] ) && !empty( $current_author_meta[ 'fax_number' ][0] ) ) {
        ?><li class="fax"><span><?php _e( 'Fax:', 'makani' ); ?></span><?php echo esc_html( $current_author_meta[ 'fax_number' ][0] ); ?></li><?php
    }
    ...
    if ( isset( $current_author_meta[ 'office_address' ] ) && !empty( $current_author_meta[ 'office_address' ][0] ) ) {
        ?><li class="map-pin"><?php echo esc_html( $current_author_meta[ 'office_address' ][0] ); ?></li><?php
    }
    ?>
